...
<div class="input-group form-group">
	...
	<input v-model="document" type="text" class="form-control" placeholder="username">
...
Don't have an account?<router-link to="/login1">Sign Up</router-link>
</div>
...
margin-bottom: auto;
width: 400px;
background-color: rgba(77, 71, 71, 0.5)  !important;
}
